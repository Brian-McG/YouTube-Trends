...
current_date = datetime.date(2016, 02, 26)
...
# sql_count_statement = """SELECT * FROM youtube_comments where video_id = %s limit 10"""""
with open(filename, 'w') as outfile:
    outfile.write("date_published,comment_count\n")
    ...
    while current_date >= publish_date:
        ...
        outfile.write("{0},{1}\n".format(datetime.date.strftime(current_date, DATE_FORMAT), count))
